declare module "translation-client" {
    ...
    */
    export class TranslationService {
         ...
         */
        getSenseTranslations(senseId: string, fingerprint?: string): Promise<string[]>;
        /**
     ...
     */
    export function createTranslation(token: string, senseId: string, options?: Partial<AppTranslationConfig>): AppTranslation;
