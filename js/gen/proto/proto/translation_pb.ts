 ...
 */
export class TextRequest extends Message<TextRequest> {
  /**
   * 要翻译的原文
   *
   * @generated from field: string text = 1;
 ...
 */
export class LLMTranslateRequest extends Message<LLMTranslateRequest> {
  /**
   * 要翻译的原文
   *
   * @generated from field: string text = 1;
 ...
 */
export class LLMTranslateResponse extends Message<LLMTranslateResponse> {
  /**
   * 翻译结果
   *
