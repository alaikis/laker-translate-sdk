...
const file_google_api_http = /*@__PURE__*/
  codegenv2.fileDesc("");
...
const file_google_api_annotations = /*@__PURE__*/
  codegenv2.fileDesc("", [file_google_api_http, wkt.file_google_protobuf_descriptor]);
 ...
 */
const file_translation = /*@__PURE__*/
  codegenv2.fileDesc("", [file_google_api_annotations]);
 ...
 */
const GetSenseTranslateRequestSchema = /*@__PURE__*/
  codegenv2.messageDesc(file_translation, 0);
 ...
 */
const GetSenseTranslateResponseSchema = /*@__PURE__*/
  codegenv2.messageDesc(file_translation, 2);

/**
 * Describes the message translation.TranslateStreamRequest.
 * Use `create(TranslateStreamRequestSchema)` to create a new message.
 */
const TranslateStreamRequestSchema = /*@__PURE__*/
  codegenv2.messageDesc(file_translation, 3);
 ...
 */
const TranslateStreamResponseSchema = /*@__PURE__*/
  codegenv2.messageDesc(file_translation, 4);

/**
 * Describes the message translation.LLMTranslateRequest.
 * Use `create(LLMTranslateRequestSchema)` to create a new message.
 */
const LLMTranslateRequestSchema = /*@__PURE__*/
  codegenv2.messageDesc(file_translation, 5);

/**
 * Describes the message translation.LLMTranslateResponse.
 * Use `create(LLMTranslateResponseSchema)` to create a new message.
 */
const LLMTranslateResponseSchema = /*@__PURE__*/
  codegenv2.messageDesc(file_translation, 6);
...
const TranslationService = {
  ...
  methods: {
    ...
    translateStream: {
      ...
      kind: connect.MethodKind.ServerStreaming,
    },
    /**
    ...
    translateBidirectional: {
      ...
      I: TranslateStreamRequestSchema,
      O: TranslateStreamResponseSchema,
      kind: connect.MethodKind.BiDiStreaming,
    },
    /**
    ...
    lLMTranslate: {
      name: "LLMTranslate",
      I: LLMTranslateRequestSchema,
      O: LLMTranslateResponseSchema,
      kind: connect.MethodKind.Unary,
    },
    /**
...
class TranslationPool {
    ...
    async processQueuedRequests(maxRetries = 3, retryDelayMs = 1000) {
        ...
        results.forEach(({ text, translation }, index) => {
            ...
            if (queuedReq && queuedReq.resolveFunction) {
                const response = protobuf.create(LLMTranslateResponseSchema, {
                    originalText: text,
    ...
    async loadFingerprintTranslations(fp, fingerprint, toLang) {
        ...
        let updatedCount = 0;
        let addedCount = 0;
        const req = protobuf.create(TranslateStreamRequestSchema, {
            senseId: this.senseId,
            fingerprint,
            dstLang: toLang,
        });
        ...
        for await (const response of stream) {
            ...
            Object.entries(response.translation).forEach(([text, translate]) => {
                ...
                if (this.pendingResolutions[key]) {
                    const responseObj = protobuf.create(LLMTranslateResponseSchema, {
                        originalText: text,
...
class TranslationClient {
    ...
    constructor(options) {
        ...
        this.transport = connectWeb.createConnectTransport({
            baseUrl,
            useHttpGet: false,
        });
        this.client = connect.createPromiseClient(TranslationService, this.transport);
    ...
    async translateWithDetails(text, toLang, fromLang, fingerprint) {
        const req = protobuf.create(LLMTranslateRequestSchema, {
            text,
            toLang,
        });
        if (fromLang) {
    ...
    async getSenseTranslations(options) {
        const req = protobuf.create(GetSenseTranslateRequestSchema, {
