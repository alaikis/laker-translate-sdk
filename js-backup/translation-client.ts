...
} from './gen/proto/translation_pb';
import { TranslationService } from './gen/proto/translation_connect';
...
function create<T>(schema: any, json: any): any {
  return protoCreate(schema, json) as any;
}
